...
namespace RedContritio
{
	namespace Experiment
	{
		...
		void MatDifference(cv::Mat& mat1, cv::Mat mat2, bool contrast,const char* name)
		{
...
#pragma warning(pop)
				...
				std::for_each(dif.begin<cv::Vec3b>(), dif.end<cv::Vec3b>(), [](cv::Vec3b& v){v[0] = ~v[0], v[1] = ~v[1], v[2] = ~v[2];});
				cv::imshow(str, dif);
			}
			return ;
		}
